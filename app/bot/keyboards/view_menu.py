...
def viewer_keyboard(category: str, page: int):
    ...
    prev_button = InlineKeyboardButton(text="Назад", callback_data="prev_page")
    next_button = InlineKeyboardButton(text="Далее", callback_data="next_page")
...
def admin_viewer_keyboard(category: str, page: int):
    ...
    prev_button = InlineKeyboardButton(text="Назад", callback_data="admin_prev_page")
    next_button = InlineKeyboardButton(text="Далее", callback_data="admin_next_page")
    page_button = InlineKeyboardButton(text=f"{page}/{length}", callback_data="page_number")
